                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              overflow: TextOverflow.ellipsis,
                                                                              textAlign: TextAlign.left,
                                                                              style: AppStyle.txtPoppinsMedium1045))
                                                                    ])))
                                                      ])),
                                              GestureDetector(
                                                  onTap: () {
                                                    onTapTxtSignupbutton(
                                                        context);
                                                  },
                                                  child: Container(
                                                      width: getHorizontalSize(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Align(
                                                                          ...
                                                                          child: Card(
                                                                              ...
                                                                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(getHorizontalSize(9))),
                                                                              child: Container(
                                                                                  height: getSize(19),
                                                                                  width: getSize(19),
